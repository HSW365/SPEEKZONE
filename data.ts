...
export const MOCK_CLIPS: Clip[] = [
  {
    id: '1', userId: '1', username: 'HOODSTAR365', userVerified: true,
    caption: 'SpeekZone is live 🌍 we global now — speak your world #speekzone #launch',
    // TODO: replace with your real Cloudinary clip URL, e.g.
    // 'https://res.cloudinary.com/<your-cloud-name>/video/upload/v1/speekzone/clip1.mp4'
    videoUrl: 'https://res.cloudinary.com/demo/video/upload/v1689000000/samples/elephants.mp4',
    ...
    tags: ['speekzone','launch'], createdAt: '2026-06-23',
  },
  {
    id: '2', userId: '2', username: 'CreatorKing', userVerified: true,
    caption: 'This beat go crazy 🔥 drop a fire if you feel this #music #vibes #speekzone',
    videoUrl: '', // TODO: add real clip URL — leave empty to show the SpeekZone placeholder card
  ...
  {
    id: '3', userId: '3', username: 'EntrepreneurTV', userVerified: true,
    caption: 'How I made $10k this month from my phone alone 💰 #business #money #grind',
    videoUrl: '', // TODO: add real clip URL
  ...
  {
    id: '4', userId: '4', username: 'AliTorres', userVerified: false,
  ...
  {
    id: '5', userId: '5', username: 'DevKing', userVerified: false,
